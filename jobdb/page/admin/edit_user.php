...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE users SET name='$name', surname='$surname', email='$email', tel='$tel', position='$position', store_id='$store_id' WHERE user_id='$user_id'";
...
<body>
    <div class="container mt-5">
        ...
        <form action="edit_user.php" method="post">
            ...
            <div class="mb-3">
                <label class="form-label">Store_ID:</label>
                <input type="store_id" name="store_id" value="<?= htmlspecialchars($store_id) ?>" class="form-control" required>
            </div>
