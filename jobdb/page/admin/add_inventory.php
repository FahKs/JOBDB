...
$sql = "INSERT INTO list_product (product_name, category, price_set, product_info, quantity_set, product_pic) 
        VALUES (?, ?, ?, ?, ?, ?)";
...
<body>
    <div class="container">
        ...
        <form action="" method="post" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="quantity_set" class="form-label">Quantity_Set</label>
